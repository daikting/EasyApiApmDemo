...
// import com.easyapi.agent.TestinAgent;
// import com.easyapi.agent.TestinAgentConfig;
import com.easyapi.apm.android.ApmAgent;
...
public class MainActivity extends Activity {
    ...
    public Button mRetrofitTestBtn;
    ...
    private void init() {
        ...
        mRetrofitTestBtn = (Button) findViewById(R.id.retrofit_test_btn);
        mRetrofitTestBtn.setOnClickListener(l);
        ...
        String appKey = "E7LPj19xPZ4D2R19";
        String appSecret = "Pr4PERp3r3jSnAag";
        ApmAgent.start(this,appSecret,appKey);
        // String key = "4b0a150f3d024029b662cdd788eb8c57";
        // NBSAppAgent.setLicenseKey(key).withLocationServiceEnabled(true).start(this);
    }
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.retrofit_test_btn:
                    intent.setClass(MainActivity.this, HttpTestActivity.class);
                    intent.putExtra(Config.TEST_TYPE_KEY, Config.TYPE_RETROFIT);
                    break;
